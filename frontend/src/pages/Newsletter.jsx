            ...
            <div className="flex flex-1 flex-col md:flex-row items-start justify-center px-4 pt-16 gap-8">
                ...
                <div className="p-8 rounded-xl max-w-lg text-left animate-[slideInLeft_1s_ease-in-out]">
                    ...
                    <div className="mb-6 text-white">
                        <ul className="space-y-4 text-white">
                            <li className="flex items-center gap-3">
                                ...
                                <span><strong>Guias e Tutoriais:</strong> Aprenda como implementar e otimizar soluções de IoT.</span>
                            </li>

                            <li className="flex items-center gap-3">
                                <img src={icone} alt="Ícone" className="w-5 h-5 mb-2" />
                                <span><strong>Notícias e Tendências:</strong> Fique por dentro das últimas novidades do IoT.</span>
                            </li>

                            <li className="flex items-center gap-3">
                                <img src={icone} alt="Ícone" className="w-5 h-5 mb-2" />
                                <span><strong>Ofertas e Promoções:</strong> Receba promoções exclusivas na newsletter.</span>
                            </li>
                        </ul>
                    ...
                    <form className="flex flex-col items-start space-y-4">
                        ...
                        <button
                            type="submit"
                            className="bg-blue-600 text-white px-6  py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors duration-150 cursor-pointer transition"
                        >
                            <Link to={'/confirmation'}>
                                Assinar Newsletter</Link>
                        </button>
                    </form>
                </div>
